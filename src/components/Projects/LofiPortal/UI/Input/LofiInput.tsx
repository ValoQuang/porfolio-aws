      ...
      <div>
        ...
        <div>
          <input
            ...
            required
            className={`${
              error && touched ? "ring-red-500" : "ring-grey-300"
            } w-full hover:bg-stone-800 border-0 p-1.5 shadow-sm ring-1 ring-inset ring-gray-300 lofi-container focus:ring-2 focus:ring-inset focus:ring-orange-400 sm:text-sm sm:leading-6`}
          />
        </div>
      </div>
    </>
