...
const Readme = () => {
  return (
    <div><h1 className="center">Hi 👋, I'm Quang</h1>
    <h3 className="center">
      A passionate frontend developer with Cloud mindset
    </h3>
    - 🔭 I’m currently working at [SayDuck](https://www.sayduck.com/)
    - 🌱 I’m currently learning **AWS solution architect** - 📫 How to
    reach me **qtruongngoc95@gmail.com** - ⚡ Fun fact **I love to
    fly, learning about space**
    ...
    <div className="flex justify-start gap-5">
      ...
      <a
        href="https://www.facebook.com/ngoc.quang.995/"
        target="blank"
      >
        <img
