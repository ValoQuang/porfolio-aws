              ...
              <div className="pr-5">
                <Paragraph
                  ...
                  children={
                    <>
                      <p>
                        I came to Finland in 2014, as a student back then, I
                        studied in Metropolia UAS in Electrical Engineering.
                      </p>
                      <br />
                      <p>
                ...
                <Paragraph
                  ...
                  children={
                    <>
                      <p>
                        From the trainee to Frontend engineer, I have worked
                        with wide range of tools and technologies.
                      </p>
                      <br />
                      <p>
